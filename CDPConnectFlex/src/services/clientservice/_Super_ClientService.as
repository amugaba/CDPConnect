...
internal class _Super_ClientService extends com.adobe.fiber.services.wrapper.RemoteObjectServiceWrapper
{
    ...
    public function _Super_ClientService()
    {
        ...
        operation = new mx.rpc.remoting.Operation(null, "getClientIDByWitsID");
    ...
    /**
      * This method is a generated wrapper used to call the 'getClientIDByWitsID' operation. It returns an mx.rpc.AsyncToken whose 
      * result property will be populated with the result of the operation when the server response is received. 
      * To use this result from MXML code, define a CallResponder component and assign its token property to this method's return value. 
      * You can then bind to CallResponder.lastResult or listen for the CallResponder.result or fault events.
      *
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function getClientIDByWitsID(witsid:String) : mx.rpc.AsyncToken
    {
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("getClientIDByWitsID");
		var _internal_token:mx.rpc.AsyncToken = _internal_operation.send(witsid) ;
        return _internal_token;
    }
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function saveNotes(item:valueObjects.ClientVO) : mx.rpc.AsyncToken
    {
