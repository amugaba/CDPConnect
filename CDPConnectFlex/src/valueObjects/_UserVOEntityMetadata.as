...
internal class _UserVOEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("username", "name", "password", "initials", "facility", "email", "admin");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("username", "name", "password", "initials", "facility", "email", "admin");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("username", "name", "password", "initials", "facility", "email", "admin");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("username", "name", "password", "initials", "facility", "email", "admin");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("username", "name", "password", "initials", "facility", "email", "admin");
