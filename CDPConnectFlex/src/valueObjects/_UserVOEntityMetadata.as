...
internal class _UserVOEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("autoid", "username", "name", "password", "initials", "facility", "email", "admin", "grantid", "eulaSigned", "passwordChangedDate");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array();
    model_internal static var allAlwaysAvailableProperties:Array = new Array("autoid", "username", "name", "password", "initials", "facility", "email", "admin", "grantid", "eulaSigned", "passwordChangedDate");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("autoid", "username", "name", "password", "initials", "facility", "email", "admin", "grantid", "eulaSigned", "passwordChangedDate");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("autoid", "username", "name", "password", "initials", "facility", "email", "admin", "grantid", "eulaSigned", "passwordChangedDate");
