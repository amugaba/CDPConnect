 ...
 * of this value object you may modify the generated sub-class of this class - GpraVO.as.
 */
...
[ExcludeClass]
public class _Super_GpraVO extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("GpraVO") == null)
            {
                flash.net.registerClassAlias("GpraVO", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _GpraVOEntityMetadata;
    ...
    private var _internal_clientid : int;
    ...
    {
        var oldValue:int = _internal_clientid;
        if (oldValue !== value)
        {
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _GpraVOEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _GpraVOEntityMetadata) : void
    {
        var oldValue : _GpraVOEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
